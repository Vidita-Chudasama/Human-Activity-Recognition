...
ap.add_argument("-o", "--output", type=str, required=True, help="optional path to video file")
ap.add_argument("-e", "--codec", required=True, help="extinction of video file")
args = vars(ap.parse_args())

# load the contents of the class labels file, then define the sample duration (i.e., # of frames for classification) and sample size
...
# initialize the video writer, dimensions of the frame
writer = None
...
while True:
    ...
    for i in range(0, SAMPLE_DURATION):
        ...
        if not grabbed:
            ...
            writer.release()
            print("[INFO] See the output video")
            sys.exit(0)
    ...
    for frame in frames:
        ...
        # append the video to output file
        if writer is None:
